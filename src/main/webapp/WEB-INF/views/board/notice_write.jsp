    ...
    <div class="row" style="padding-top:50px; padding-bottom: 50px">
      ...
      <div class="col-sm-6">
        <div class="main" style="border-bottom:2px solid black">
          <h4>공지사항 작성<span> 콜라비의 새로운 소식들과 유용한 정보들을 등록하세요</span></h4>
        </div>
        <div>
         <form name="frm" method="post" enctype="multipart/form-data">
              ...
              <thead>
                <tr style="height: 60px;">
                  ...
                  <th style="vertical-align: left; border-bottom-color: white;">
                   	<input type="text" class="title" name="noticeTitle" placeholder="제목을 입력하세요.">
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td>
                    <textarea class="form-control" rows="18" id="content" name="noticeContent" placeholder="내용을 입력하세요."></textarea>
          ...
          <div style="text-align: right;">
            <button class="back_btn" type="button" onclick="location.href='notice.do'"
