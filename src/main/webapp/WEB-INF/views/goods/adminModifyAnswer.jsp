          ...
          <table class="table">
            <tbody>
              <tr style="height: 60px;">
                <td style="width: 10%; vertical-align: middle; border-top-color: black; border-bottom-color: white;">상품명</td>
                <td style="vertical-align: middle; border-color: gray; text-align: left;">
 					상품명 불러오기 
                </td>
              </tr>
              <tr style="height: 60px;">
                <td style="width: 10%; vertical-align: middle;">제목</td>
              ...
              <tr>
                ...
                <td>
                  <textarea class="form-control" rows="18" id="comment" name="aAnswer"
                    placeholder="답변 내용을 입력하세요.">${qna.aAnswer }</textarea>
            ...
            <button class="back_btn" type="button" onclick="location.href='adminGoodsQue.do'"
              style="width: 120; height: 44; border-radius: 3;">취소</button>
            <button class="answer_btn" type="button" onclick="check_answer(${qna.proQnaNum })" style="width: 120; height: 44; border-radius: 3;">수정</button>
          </div>
          </form>
        </div>
      </div>
...
<script>
  ...
  function check_answer(proQnaNum) {
	    var frm = document.frm;
	    console.log(frm);
	    if (frm.aAnswer.value == "") {
	        alert("답변을 입력해주세요.");
	      return false;
	    } else {
	      	frm.action="answerQna.do?proQnaNum="+${qna.proQnaNum };
	      	frm.submit();
	    }
	  }
</script>
