    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ul class="list-group list-group-flush  side-bar-box">
                <li class="list-group-item  d-flex justify-content-between search-filter-top" style="padding: 0px 0px 15px 0px;">
                    ...
                    <div> 
                        <ul>
                            <li>
								 <button onclick="setSearchFilter('recommend')">추천순</button>
            ...
            <div id="show-more-area" style="display: flex; justify-content: center;">
            	<button id="moreButton" onclick="run_show_more('IN')" style="width: 250px; height: 100px; font-size: 30px; color: white; background-color: #9A30AE; font-weight: 800;">더보기</button>
